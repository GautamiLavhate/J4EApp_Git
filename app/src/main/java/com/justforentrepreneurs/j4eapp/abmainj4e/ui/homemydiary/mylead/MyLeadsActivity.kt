...
import com.justforentrepreneurs.j4eapp.abmainj4e.ui.homemydiary.mylead.adapter.MyLeadsPagerAdapter
import com.google.android.material.tabs.TabLayout

class MyLeadsActivity : BaseActivity() {
    ...
    private fun setupViewPager() {
        val viewPagerAdapter = MyLeadsPagerAdapter(supportFragmentManager)
