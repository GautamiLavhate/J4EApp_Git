...
public class ActivityMyLeadsStatusAddBindingImpl extends ActivityMyLeadsStatusAddBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.rvCategory, 8);
        sViewsWithIds.put(R.id.noteTextview, 9);
        sViewsWithIds.put(R.id.edtFeedback, 10);
        sViewsWithIds.put(R.id.paymentselectedli, 11);
        sViewsWithIds.put(R.id.amount, 12);
        sViewsWithIds.put(R.id.enterdate, 13);
        sViewsWithIds.put(R.id.Radioli, 14);
        sViewsWithIds.put(R.id.radiotext, 15);
        sViewsWithIds.put(R.id.radioGrp, 16);
        sViewsWithIds.put(R.id.radioM, 17);
        sViewsWithIds.put(R.id.radioF, 18);
        sViewsWithIds.put(R.id.edtlocation, 19);
    }
    // views
    @NonNull
    ...
    public ActivityMyLeadsStatusAddBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 20, sIncludes, sViewsWithIds));
    }
    private ActivityMyLeadsStatusAddBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
