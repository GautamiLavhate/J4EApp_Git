...
public class ViewPagerAdapterGalleryViewAnimity extends PagerAdapter {

    private Context context;
    private ArrayList<GalleryInfo> sliderImg;


    public ViewPagerAdapterGalleryViewAnimity(ArrayList<GalleryInfo> sliderImg, Context context) {
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        Glide.with(context).load(sliderImg.get(position).getImage_link()).into(imageView);
