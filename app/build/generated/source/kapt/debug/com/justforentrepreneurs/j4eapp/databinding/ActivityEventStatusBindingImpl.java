...
public class ActivityEventStatusBindingImpl extends ActivityEventStatusBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.labelLinLay, 7);
        sViewsWithIds.put(R.id.backgroundView1, 8);
        sViewsWithIds.put(R.id.eventStatusRecyclerView, 9);
    ...
    public ActivityEventStatusBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 12, sIncludes, sViewsWithIds));
    }
    private ActivityEventStatusBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
