...
import com.justforentrepreneurs.j4eapp.databinding.ActivityReferralGivenBinding

class ReferralGivenActivity : AppCompatActivity() {
    private lateinit var binding:ActivityReferralGivenBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DataBindingUtil.setContentView(this,R.layout.activity_referral_given)
        ...
        binding.toolbar.tvTitle.text = resources.getText(R.string.Referralsgiven)
        setupViewPager()
    }

    private fun setupViewPager() {
        val viewPagerAdapter = ReferralPagerAdapter(supportFragmentManager)
