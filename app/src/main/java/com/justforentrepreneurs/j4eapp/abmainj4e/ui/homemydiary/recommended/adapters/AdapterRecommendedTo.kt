...
class AdapterRecommendedTo(activity: FragmentActivity?, companyName: MutableList<RecommandByTo.RecommandBydata>, val OnClickLiner:FragRecommendedTo) :
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        mViewHolder.itemView.setOnClickListener {
            if (mData.get(position).requirement_id!=null || mData.get(position).userid!=null){
