...
public class AbProfilleviewBindingImpl extends AbProfilleviewBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tvAboutCompany, 20);
        sViewsWithIds.put(R.id.tvCompanyName, 21);
        sViewsWithIds.put(R.id.tvBusinessEntity, 22);
        sViewsWithIds.put(R.id.tvBusinessType, 23);
        sViewsWithIds.put(R.id.tvBusinessExpertise, 24);
        sViewsWithIds.put(R.id.tvWorkingForm, 25);
        sViewsWithIds.put(R.id.tvNoOfEmployee, 26);
        sViewsWithIds.put(R.id.tvExpectedTurnOver, 27);
        sViewsWithIds.put(R.id.tvTagetAudience, 28);
    }
    // views
    @NonNull
    ...
    public AbProfilleviewBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 29, sIncludes, sViewsWithIds));
    }
    private AbProfilleviewBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
