...
public class ActivityAllMembersBindingImpl extends ActivityAllMembersBinding  {
    ...
    public ActivityAllMembersBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 17, sIncludes, sViewsWithIds));
    }
    private ActivityAllMembersBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.justforentrepreneurs.j4eapp.abmainj4e.ui.allmembers.viewmodel.AllMembersViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.justforentrepreneurs.j4eapp.abmainj4e.ui.allmembers.viewmodel.AllMembersViewModel ViewModel) {
