...
import com.justforentrepreneurs.j4eapp.databinding.PostInfoBinding

class AdapterPostInfo (activity: FragmentActivity?,
                       companyName: MutableList<PostCategrory.Postdata>) :
    RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    private lateinit var mBinding: PostInfoBinding
