...
class AdapterFollowupMeetMonth(activity: FragmentActivity?, companyName:MutableList<FollowUp.UserData>,count_available: Int) :
    RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    private lateinit var mBinding: AdapterBuddymonthBinding
    private var mData:MutableList<FollowUp.UserData> = companyName
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        val mAdapter = AdapterPRBuddyMeet(mContext as FragmentActivity?,
                mData.get(position).Data as MutableList<FollowUp.Datafollowup>,count_available1)
