...
import com.justforentrepreneurs.j4eapp.databinding.FragmentCompletedReferralBinding
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response


class CompletedReferralFragment : Fragment(),AdapterCompletedReferral.OnClick2 {
    private lateinit var binding:FragmentCompletedReferralBinding
    ...
    override fun onCreateView(
        ...
        // Inflate the layout for this fragment
         binding = DataBindingUtil.inflate(inflater,R.layout.fragment_completed_referral, container, false)
        recyclerData()
        return binding.root
    }
    ...
    private fun getRequirements(){
        ...
        val call = request.app_get_complete_referral(readUsingSharedPreference(requireActivity(), "userid").toString())
                    ...
                    if (response.body()?.status == true) {
                        if (response.body()?.data != null) {
                            ...
                            val mAdapter = AdapterCompletedReferral(
                                activity,
                                response.body()?.data as MutableList<Data>,this@CompletedReferralFragment,"given")
