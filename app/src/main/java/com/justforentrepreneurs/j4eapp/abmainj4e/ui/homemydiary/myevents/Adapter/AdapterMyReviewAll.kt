...
class AdapterMyReviewAll(activity: FragmentActivity?, companyName: MutableList<EventDetails.Alleventsdata.Allreviews>, onClick2:MyEventsDetailsActivity) :
    RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    private lateinit var mBinding: AdapterMyTestimonialsBinding
    private var mData: MutableList<EventDetails.Alleventsdata.Allreviews> = companyName
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        holder.mBinding.ivName.text=mData.get(position).reviewed_by
