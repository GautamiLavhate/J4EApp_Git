...
public class ActivityMyConnectionsBindingImpl extends ActivityMyConnectionsBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tabHome, 3);
        sViewsWithIds.put(R.id.vpHome, 4);
    }
    // views
    @NonNull
    ...
    public ActivityMyConnectionsBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }
    private ActivityMyConnectionsBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            ...
            , (com.justforentrepreneurs.j4eapp.abmainj4e.NonSwipeableViewPager) bindings[4]
            );
