...
class AdapterFunctionalArea(
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        mViewHolder.itemView.setOnClickListener {
            onClick2.OnClickFunctionalArea(mData[position].area,mData[position].area_id)
        }
    }

    interface OnClick2 {
        fun OnClickFunctionalArea(position: String, id:String)
    }
