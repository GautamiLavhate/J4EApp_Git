...
import com.justforentrepreneurs.j4eapp.databinding.WelcomeSlideDBinding

class Intro4Fragment : Fragment() {

    private lateinit var binding: WelcomeSlideDBinding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?
    ): View? {
        binding = DataBindingUtil.inflate(inflater, R.layout.welcome_slide_d, container, false)
        binding.tvTitle.text = "Make more connect and chat"
