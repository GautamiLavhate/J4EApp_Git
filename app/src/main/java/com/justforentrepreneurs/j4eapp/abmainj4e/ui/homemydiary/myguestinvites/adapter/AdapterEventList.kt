...
class AdapterEventList (
    ...
    companyName: MutableList<Allevents.Alleventsdata>,
    onClick2: OnClick2
) :
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        mViewHolder.mBinding.tvCategory.text = mData.get(position).event_title
        mViewHolder.itemView.setOnClickListener {
            onClick2.OnClick(mData[position].event_title,mData[position].event_id,mData[position].event_guest_fees)
        }
    }

    interface OnClick2 {
        fun OnClick(position: String,id:String,gustfees:String)
    }
