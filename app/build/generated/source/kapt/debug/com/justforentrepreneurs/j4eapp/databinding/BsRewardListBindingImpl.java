...
public class BsRewardListBindingImpl extends BsRewardListBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(1, 
            new String[] {"ab_j4emembers", "ab_j4emembers", "ab_j4emembers", "ab_j4emembers"},
            new int[] {2, 3, 4, 5},
        ...
        sViewsWithIds.put(R.id.searchLinLay, 8);
        sViewsWithIds.put(R.id.rvRewardList, 9);
        sViewsWithIds.put(R.id.NoLeadInvited, 10);
        sViewsWithIds.put(R.id.default_text, 11);
    }
    // views
    @NonNull
    ...
    public BsRewardListBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 12, sIncludes, sViewsWithIds));
    }
    private BsRewardListBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            ...
            , (android.widget.SearchView) bindings[8]
