...
class AdapterRecommendCreatedList(activity: FragmentActivity?, companyName: MutableList<MyRecommadPeo.DataLeadSt.Created>) :
    RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    private lateinit var mBinding: AdapterRecommandexitinglistBinding
    private var mData:  MutableList<MyRecommadPeo.DataLeadSt.Created>  = companyName
