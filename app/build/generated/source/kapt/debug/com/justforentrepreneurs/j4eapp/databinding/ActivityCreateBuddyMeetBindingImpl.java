...
public class ActivityCreateBuddyMeetBindingImpl extends ActivityCreateBuddyMeetBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.edtlocation, 11);
        sViewsWithIds.put(R.id.edtDate, 12);
        sViewsWithIds.put(R.id.layoutmanager1, 13);
    }
    // views
    @NonNull
    ...
    public ActivityCreateBuddyMeetBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 14, sIncludes, sViewsWithIds));
    }
    private ActivityCreateBuddyMeetBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
