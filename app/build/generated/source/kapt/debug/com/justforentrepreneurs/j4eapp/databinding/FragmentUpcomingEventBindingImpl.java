...
public class FragmentUpcomingEventBindingImpl extends FragmentUpcomingEventBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.rvCommon, 11);
        sViewsWithIds.put(R.id.Noevents, 12);
        sViewsWithIds.put(R.id.default_text, 13);
        sViewsWithIds.put(R.id.fabFilter, 14);
    }
    // views
    @NonNull
    ...
    public FragmentUpcomingEventBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 15, sIncludes, sViewsWithIds));
    }
    private FragmentUpcomingEventBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
