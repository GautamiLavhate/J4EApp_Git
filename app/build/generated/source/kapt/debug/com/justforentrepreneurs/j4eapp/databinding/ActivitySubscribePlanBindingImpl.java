...
public class ActivitySubscribePlanBindingImpl extends ActivitySubscribePlanBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.crdTitle, 9);
        sViewsWithIds.put(R.id.rvMembershipTitle, 10);
        sViewsWithIds.put(R.id.rvMembershipFeature, 11);
    }
    // views
    @NonNull
    ...
    public ActivitySubscribePlanBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 12, sIncludes, sViewsWithIds));
    }
    private ActivitySubscribePlanBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
