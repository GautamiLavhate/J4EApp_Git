...
import com.justforentrepreneurs.j4eapp.abmainj4e.ui.homemydiary.mylead.FragCompletedMyLeads
...
class AdapterCompletedMyLead(activity: FragmentActivity?, companyName: MutableList<MyLeadcomplete.MyRequirementpending>, onClick2:FragCompletedMyLeads) :
        RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    private lateinit var mBinding: AdapterCompletedMyleadBinding
    private var mData: MutableList<MyLeadcomplete.MyRequirementpending> = companyName
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        mBinding = DataBindingUtil.inflate(
                ...
                R.layout.adapter_completed_mylead,
                parent,
                false
        )
    ...
    class ItemViewHolder internal constructor(
            itemView: View?,
            val mBinding: AdapterCompletedMyleadBinding
    ) :
