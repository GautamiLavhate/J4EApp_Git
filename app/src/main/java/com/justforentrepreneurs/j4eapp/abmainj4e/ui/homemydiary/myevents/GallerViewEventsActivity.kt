...
import com.justforentrepreneurs.j4eapp.abmainj4e.ui.homemydiary.myevents.Adapter.ViewPagerAdapterGalleryViewEvents
...
class GallerViewEventsActivity : AppCompatActivity() {
    private var galleryArrayList: ArrayList<EventDetails.Alleventsdata.Gallerydata>? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val intent = intent
        galleryArrayList = intent.getSerializableExtra("Image") as ArrayList<EventDetails.Alleventsdata.Gallerydata>
        position = intent.getStringExtra("pos")

        val galleryViewPagerAdapter = ViewPagerAdapterGalleryViewEvents(galleryArrayList,this)
