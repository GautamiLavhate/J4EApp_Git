...
class AdapterBusinessEntity(activity: FragmentActivity?,
                            gender: MutableList<String>,
                            onClick2: OnClickBusinessEntity
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        mViewHolder.itemView.setOnClickListener {
            onClick2.OnClickBusinessEntity(mData.get(position).toString())
        }
    }

    interface OnClickBusinessEntity {
        fun OnClickBusinessEntity(gender:String)
    }
